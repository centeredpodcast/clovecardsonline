...
const cards = 0; //This will eventually get all of the cards possible!
let yourCards = []; //This will eventually be a list of all the cards you have.
let activeDeck; //Ths will eventually be the ID (if you will) of the deck that you are currently using.
